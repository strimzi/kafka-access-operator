...
You can optionally also specify the name of the listener in the Kafka CR using `spec.kafka.listener`, the name of the secret the Kafka Access Operator creates using `spec.secretName` and a `KafkaUser`.
